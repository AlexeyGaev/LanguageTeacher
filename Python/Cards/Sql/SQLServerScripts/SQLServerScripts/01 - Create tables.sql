Create table Themes(Theme_Id integer not null default 1 PRIMARY KEY, Theme_Desc text);
Create table Cards(Card_Id integer not null default 1 PRIMARY KEY,Primary_Side text,Secondary_Side text);
