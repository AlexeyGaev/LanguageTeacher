headers = {
    ...
    'CreateView': 'Создаем все представления',
    'DropView': 'Удаляем все представления',
    'ShowViews': 'Вывод содержимого представлений.',
...
menues = {
    'Main' : {
        ...
        'Items' : [
            ...
            (2, 'Операции с представлениями', b'2'),
            (3, 'Операции с карточками', b'3'),
            (4, 'Пройти тестирование', b'4'),
            (5, 'Отправить изменения в базу данных', b'5'),
            ]
        },
    'Tables': {
        'Headers' : [
    ...
    'Views': {
        ...
        'Items' : [
            (1, 'Создать все новые представления', b'1'),
            (2, 'Удалить все существующие представления', b'2'),
            (3, 'Показать содержимое всех представлений', b'3')
            ]
        },
    'Cards': {
        'Headers' : [
