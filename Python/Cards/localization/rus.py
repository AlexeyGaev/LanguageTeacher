...
menues = {
    'Main' : {
        ...
        'Items' : [
            (1, 'Операции с таблицами и представлениями', b'1'),
            (2, 'Операции с карточками', b'2'),
            (3, 'Пройти тестирование', b'3')
            ]
        },
    'Tables': {
        'Headers' : [
        ...
        'Items' : [
            (1, 'Создать все новые таблицы и представления', b'1'),
            (2, 'Удалить все существующие таблицы и представления', b'2'),
            (3, 'Очистить все существующие таблицы', b'3'),
            (4, 'Показать содержимое всех таблиц и представлений', b'4')
            ]
        },
    'Cards': {
        'Headers' : [
